...
@interface EmailedDetailedController () {
...
@implementation EmailedDetailedController
...
- (void)viewDidLoad {
    ...
    EmailedMediaModel *media = self.model.media[0];
    EmailedMediaMetadataModel *mediaURl = media.mediaMetadata[2];
